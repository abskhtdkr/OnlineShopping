...
<head>
    ...
    <link href="http://localhost:8080/OnlineShopping/css/fontawesome-all.css" rel="stylesheet">
    <link href="http://localhost:8080/OnlineShopping/css/bootstrap.min.css" rel="stylesheet">
    <link href="http://localhost:8080/OnlineShopping/css/mdb.min.css" rel="stylesheet">
    <link href="http://localhost:8080/OnlineShopping/css/style.css" rel="stylesheet">
	
	<link rel="stylesheet" href="http://localhost:8080/OnlineShopping/js/vendor/datatables/css/buttons.dataTables.min.css">
	<link rel="stylesheet" href="http://localhost:8080/OnlineShopping/js/vendor/datatables/css/dataTables.bootstrap4.min.css">
	
    <link rel="shortcut icon" href="http://localhost:8080/OnlineShopping/img/TitleImage.png">
    <style>
        th,.center{
...
<script type="text/javascript">
	/* function onloadBody() {
		$.ajax({
			url:"http://localhost:8080/OnlineShopping/CheckIsLogged",
			type:"GET",
...
<body class="fixed-sn white-skin">
    <header>
            ...
            <li>
            	<ul class="collapsible collapsible-accordion">
            		<li id="100001"><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-cogs"></i> Operations <i class="fa fa-angle-down rotate-icon"></i></a>
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li id="100003"><a href="http://localhost:8080/OnlineShopping/JSPs/Interview/JSPs/interview.jsp" class="waves-effect">Evaluation</a>
                                </li> -->
                            </ul>
                        </div>
                    </li>
                    ...
                    <li id="100001"><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-tasks"></i> Plan Of Action <i class="fa fa-angle-down rotate-icon"></i></a>
                      	<div class="collapsible-body">
                      		<ul id="ObservationsDivH">
                      			<li id="100003"><a href="http://localhost:8080/OnlineShopping/JSPs/POA/JSPs/PlanOfAction.jsp" class="waves-effect">Plan Of Action</a>
                                </li>
                      		</ul>
                    	</div>
                    </li>
                    <li id="100001"><a class="collapsible-header waves-effect arrow-r"><i class="fas fa-arrows-alt-v" style="margin-right: 18px;"></i> Top Down <i class="fa fa-angle-down rotate-icon"></i></a>
                      	<div class="collapsible-body">
                      		<ul id="ObservationsDivH">
                      			<li id="100003"><a href="http://localhost:8080/OnlineShopping/JSPs/Admin/JSPs/Projects.jsp?p=4" class="waves-effect">Top Down</a>
                                </li>
                      		</ul>
                    	</div>
                    </li>
        ...
        <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
			...
			<!-- <div>
	            <div class="md-form">
	                <input type="text" id="branchName" class="form-control text" name="productSearch" placeholder="Search">
	            </div>
			</div> -->
            <div class="input-group">
				  <input type="text" class="form-control text" placeholder="Search" id="productSearch" name="productSearch" style="padding: 2px;padding-left: 7px;">
				  <div class="input-group-append">
				  <a><span class="input-group-text" id="searchBtn"><i class="fas fa-search"></i></span></a>
				  </div>
			</div>
            <!--Navbar links-->
	...
	<!-- SCRIPTS -->
    <!-- JQuery -->
    <script src="http://localhost:8080/OnlineShopping/js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="http://localhost:8080/OnlineShopping/js/popper.min.js"></script>
    <!-- <script type="text/javascript" src="http://localhost:8080/OnlineShopping/js/General/IDGenerator.js"></script> -->
    <script type="text/javascript" src="http://localhost:8080/OnlineShopping/js/bootstrap.js"></script>
    <script type="text/javascript" src="http://localhost:8080/OnlineShopping/js/mdb.min.js"></script>
    
    <script type="text/javascript" src="http://localhost:8080/OnlineShopping/js/vendor/datatables/js/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="http://localhost:8080/OnlineShopping/js/vendor/datatables/js/dataTables.bootstrap4.min.js"></script>
	<script type="text/javascript" src="http://localhost:8080/OnlineShopping/js/vendor/datatables/js/dataTables.buttons.min.js"></script>
    
    <script>
    	/* $(document).ready(function(){
    		$.ajax({
    			url:"http://localhost:8080/OnlineShopping/GetLegendList",
    			type:"GET",
    			success:function(Data){
    				var str="";
	   				 for (i = 0; i < Data.data.length; i++){
	   			        if (Data.data[i].subCategory == "Department") {
	   						str+='<li id="100003"><a href="http://localhost:8080/OnlineShopping/JSPs/Operations/JSPs/Observations.jsp?deptid='+Data.data[i].rowId+'" class="waves-effect">'+Data.data[i].description+' Observations</a></li>';
	   			        }
	   				 }
